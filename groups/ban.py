    ...
    def ban(message):
        ...
        try:
            ...
            if "not enough rights" in error:
                error_message = (
                    "❌ ربات دسترسی کافی برای Ban کردن ندارد."
                )

            elif "administrator" in error:
                error_message = (
                    "❌ نمی‌توان ادمین را Ban کرد."
                )
